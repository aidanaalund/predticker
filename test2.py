...
raw_price_df = raw_price_df.drop(['Open', 'High', 'Low', 'Adj Close', 'Volume'
...
NUMBER_of_STEPS_BACK = 12 # Number of days back that the model will be trained for
PREDICTION_STEPS = [1,2,3,4,5,6] # Number of days that the model will predict. To predict the next three days, modify it as follows: [1,2,3]
